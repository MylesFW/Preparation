...
public class WeatherWindMediumState : State
{
    ...
    public override void Enter()
    {
        ...
        float _AirTarget = -8.0f - _tempMod;
    ...
    //Constructor
    public WeatherWindMediumState(FiniteStateMachine _fsm, ObjectContext _context, string _name = "WeatherWindMediumState", int _priority = 0, bool _locked = false, bool _forceOverride = false)
    {
        fsm = _fsm;
        name = _name;
        self = _context;
