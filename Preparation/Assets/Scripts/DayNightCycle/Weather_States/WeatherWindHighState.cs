...
public class WeatherWindHighState : State
{
    ...
    //Constructor
    public WeatherWindHighState(FiniteStateMachine _fsm, ObjectContext _context, string _name = "WeatherWindHighState", int _priority = 0, bool _locked = false, bool _forceOverride = false)
    {
        fsm = _fsm;
        name = _name;
        self = _context;
