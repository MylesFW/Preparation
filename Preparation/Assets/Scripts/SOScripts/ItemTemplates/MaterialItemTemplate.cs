...
using UnityEngine;
[CreateAssetMenu(fileName = "Item Templates", menuName = "ItemTemplates/MaterialItem")]
public class MaterialItemTemplate : ScriptableObject
{
    // Base Items
    ...
    [Tooltip("The weight of stack of this item. Serves as Max Weight for non-stackable items")]
